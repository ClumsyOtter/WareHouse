...
<body style="margin: 10px">
	...
	<div class="easyui-panel"
		...
		<div class="easyui-panel" title="入库管理"
			...
			<a href="#" onclick="parent.window.manifestAdd()" style="color:#00688B;padding-left: 25px;">入库</a> <br><br>
			<a href="#" onclick="parent.window.manifestlist()" style="color:#00688B;padding-left: 25px;">历史入库表</a> <br><br>
		</div>
	</div>
