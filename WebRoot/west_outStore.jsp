...
<body style="margin: 10px">
	...
	<div class="easyui-panel"
		...
		<div class="easyui-panel" title="出库管理"
			...
			<a href="#" onclick="parent.window.manifestAddOut()" style="color:#00688B;padding-left: 25px;">出库</a> <br><br>
			<a href="#" onclick="parent.window.manifestlistOut()" style="color:#00688B;padding-left: 25px;">历史出库表</a> <br><br>
		</div>
	</div>
