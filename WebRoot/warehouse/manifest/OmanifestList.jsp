...
<script type="text/javascript">
	$('#productorJson')
			.datagrid(
					{
						url : '${pageContext.request.contextPath}/warehouse/manifest/listOut.action',
						fit : true,
						pageSize : 15,
						pageList : [ 10, 15, 20 ],
						columns : [ [ {
...
<script type="text/javascript">
	function Update() {
		...
		str = '${pageContext.request.contextPath}/warehouse/manifest/toupdateOut.action?mid='
				+ mid;
	...
	function Delete() {
		...
		if (id.length != 0) {
			str = '${pageContext.request.contextPath}/warehouse/manifest/deleteOut.action?id='
					+ id + '&num=' + id.length;
			window.location.href = str;
		}
	}
	...
	function doSearch(value, name) {
		if (value) {
			...
			str = '${pageContext.request.contextPath}/warehouse/manifest/listOut.action';
			$('#productorJson').datagrid({
				url : str,
			});
		}
